...
const projects: Project[] = [
  {
    ...
    description: 'A modern commerce experience with product discovery, cart flows, and a polished responsive storefront built with React and TypeScript.',
    tags: ['React', 'TypeScript', 'Node.js'],
    features: ['Product catalog', 'Cart experience', 'Responsive storefront', 'Typed data flow'],
    github: 'https://github.com/ivarhinisan',
    live: 'https://example.com',
    image: projectFallbackImage,
    imageAlt: 'Landing page screenshot for the E-Commerce Platform project',
  },
  {
    title: 'Weather Dashboard',
    description: 'A real-time weather dashboard for location-based conditions, forecasts, and quick-glance environmental insights.',
    tags: ['React', 'API', 'CSS'],
    features: ['Location search', 'Live weather data', 'Forecast cards', 'Adaptive layout'],
    github: 'https://github.com/ivarhinisan',
    live: 'https://example.com',
    image: projectFallbackImage,
    imageAlt: 'Landing page screenshot for the Weather Dashboard project',
  },
  {
    title: 'Task Manager',
    description: 'A productivity workspace focused on task organization, collaborative updates, and clear project status tracking.',
    tags: ['React', 'Node.js', 'MongoDB'],
    features: ['Drag-and-drop boards', 'Real-time updates', 'Team collaboration', 'CRUD workflows'],
    github: 'https://github.com/ivarhinisan',
    live: 'https://example.com',
    image: projectFallbackImage,
    imageAlt: 'Landing page screenshot for the Task Manager project',
  },
  {
    title: 'Portfolio Website',
    description: 'A premium personal portfolio showcasing projects, skills, and services through a cinematic dark interface.',
    tags: ['React', 'TypeScript', 'CSS'],
    features: ['Responsive UI', 'Section navigation', 'Scroll animations', 'Contact experience'],
    github: 'https://github.com/ivarhinisan',
    live: 'https://example.com',
    image: projectFallbackImage,
    imageAlt: 'Landing page screenshot for the Portfolio Website project',
  },
]
