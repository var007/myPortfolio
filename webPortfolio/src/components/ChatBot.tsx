...
function getTemplateReply(input: string) {
  ...
  if (includesAny(question, ['project', 'projects', 'portfolio', 'built', 'made', 'work'])) {
    return 'His featured projects include DriveHub Premium Car Rental, Auralis Dental Booking, Kafé, and the NetServe ISP Support Console. You can explore them in the Projects section.'
  }
